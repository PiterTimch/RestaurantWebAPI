...
COPY ["RestaurantWebAPI/RestaurantWebAPI.csproj", "RestaurantWebAPI/"]
RUN dotnet restore "RestaurantWebAPI/RestaurantWebAPI.csproj"

# Копіюємо всі файли і будуємо додаток
COPY . .
WORKDIR /source/RestaurantWebAPI
